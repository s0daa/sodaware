...
import me.soda.sodaware.client.event.events.WurstplusEventRenderEntityModel;
...
public class WurstplusHack implements Listenable {
	...
	protected WurstplusSetting create(String name, String tag, int value, int min, int max) {
		Sodaware.get_setting_manager().register(new WurstplusSetting(this, name, tag, value, min, max));

		return Sodaware.get_setting_manager().get_setting_with_tag(this, tag);
	}
	...
	protected WurstplusSetting create(String name, String tag, boolean value) {
		Sodaware.get_setting_manager().register(new WurstplusSetting(this, name, tag, value));
	...
	protected WurstplusSetting create(String name, String tag, String value, List<String> values) {
		Sodaware.get_setting_manager().register(new WurstplusSetting(this, name, tag, values, value));
