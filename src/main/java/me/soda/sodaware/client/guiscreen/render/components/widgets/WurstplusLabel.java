...
public class WurstplusLabel extends WurstplusAbstractWidget {
	...
	public WurstplusLabel(WurstplusFrame frame, WurstplusModuleButton master, String tag, int update_postion) {
		this.frame   = frame;
		this.master  = master;
		this.setting = Sodaware.get_setting_manager().get_setting_with_tag(master.get_module(), tag);
	...
	public void render(int master_y, int separe, int absolute_x, int absolute_y) {
		...
		int ns_r = Sodaware.click_gui.theme_widget_name_r;
		int ns_g = Sodaware.click_gui.theme_widget_name_g;
		int ns_b = Sodaware.click_gui.theme_widget_name_b;
		int ns_a = Sodaware.click_gui.theme_widget_name_a;
