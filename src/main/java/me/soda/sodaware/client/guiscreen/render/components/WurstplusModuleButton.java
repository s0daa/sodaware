package me.soda.sodaware.client.guiscreen.render.components;

import me.soda.sodaware.Sodaware;
import me.soda.sodaware.client.guiscreen.render.WurstplusDraw;
import me.soda.sodaware.client.guiscreen.render.components.widgets.*;
...
public class WurstplusModuleButton {
	...
	public WurstplusModuleButton(WurstplusHack module, WurstplusFrame master) {
		...
		for (WurstplusSetting settings : Sodaware.get_setting_manager().get_settings_with_hack(module)) {
	...
	public void render(int mx, int my, int separe) {
		...
		int nm_r = Sodaware.click_gui.theme_widget_name_r;
		int nm_g = Sodaware.click_gui.theme_widget_name_g;
		int nm_b = Sodaware.click_gui.theme_widget_name_b;
		int nm_a = Sodaware.click_gui.theme_widget_name_a;

		int bg_r = Sodaware.click_gui.theme_widget_background_r;
		int bg_g = Sodaware.click_gui.theme_widget_background_g;
		int bg_b = Sodaware.click_gui.theme_widget_background_b;
		int bg_a = Sodaware.click_gui.theme_widget_background_a;

		int bd_r = Sodaware.click_gui.theme_widget_border_r;
		int bd_g = Sodaware.click_gui.theme_widget_border_g;
		int bd_b = Sodaware.click_gui.theme_widget_border_b;
