...
public class WurstplusPvpHud extends WurstplusPinnable {
    ...
    public String selftrap_enabled() {
        try {
            if (Sodaware.get_hack_manager().get_module_with_tag("SelfTrap").is_active()) {
                return "\u00A7a 1";
            }
            return "\u00A74 0";
        } catch (Exception e) {
    ...
    public String trap_enabled() {
        try {
            if (Sodaware.get_hack_manager().get_module_with_tag("Trap").is_active()) {
                return "\u00A7a 1";
            }
            return "\u00A74 0";
        } catch (Exception e) {
    ...
    public String aura_enabled() {
        ...
        try {
            if (Sodaware.get_hack_manager().get_module_with_tag("AutoCrystal").is_active()) {
                return "\u00A7a 1";
            }
            return "\u00A74 0";
        } catch (Exception e) {
    ...
    public String socks_enabled() {
        try {
            if (Sodaware.get_hack_manager().get_module_with_tag("Socks").is_active()) {
                return "\u00A7a 1";
            }
            return "\u00A74 0";
        } catch (Exception e) {
    ...
    public String surround_enabled() {
        ...
        try {
            if (Sodaware.get_hack_manager().get_module_with_tag("Surround").is_active()) {
                return "\u00A7a 1";
            }
            return "\u00A74 0";
        } catch (Exception e) {
    ...
    public String holefill_enabled() {
        ...
        try {
            if (Sodaware.get_hack_manager().get_module_with_tag("HoleFill").is_active()) {
                return "\u00A7a 1";
            }
            return "\u00A74 0";
        } catch (Exception e) {
