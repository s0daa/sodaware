...
public class WurstplusFrame {
	...
	public WurstplusFrame(WurstplusCategory category) {
		...
		int size  = Sodaware.get_hack_manager().get_modules_with_category(category).size();
		int count = 0;

		for (WurstplusHack modules : Sodaware.get_hack_manager().get_modules_with_category(category)) {
	...
	public void render(int mx, int my) {
		...
		int nc_r = Sodaware.click_gui.theme_frame_name_r;
		int nc_g = Sodaware.click_gui.theme_frame_name_g;
		int nc_b = Sodaware.click_gui.theme_frame_name_b;
		int nc_a = Sodaware.click_gui.theme_frame_name_a;

		int bg_r = Sodaware.click_gui.theme_frame_background_r;
		int bg_g = Sodaware.click_gui.theme_frame_background_g;
		int bg_b = Sodaware.click_gui.theme_frame_background_b;
		int bg_a = Sodaware.click_gui.theme_frame_background_a;

		int bd_r = Sodaware.click_gui.theme_frame_border_r;
		int bd_g = Sodaware.click_gui.theme_frame_border_g;
		int bd_b = Sodaware.click_gui.theme_frame_border_b;
		int bd_a = border_a;
