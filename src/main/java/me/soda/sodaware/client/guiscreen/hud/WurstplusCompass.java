...
public class WurstplusCompass extends WurstplusPinnable {
	...
	public void render() {
        ...
        int r = Sodaware.get_setting_manager().get_setting_with_tag("HUD", "HUDStringsColorR").get_value(1);
        int g = Sodaware.get_setting_manager().get_setting_with_tag("HUD", "HUDStringsColorG").get_value(1);
        int b = Sodaware.get_setting_manager().get_setting_with_tag("HUD", "HUDStringsColorB").get_value(1);
        int a = Sodaware.get_setting_manager().get_setting_with_tag("HUD", "HUDStringsColorA").get_value(1);
    ...
    private double get_x(double rad) {
        return Math.sin(rad) * (Sodaware.get_setting_manager().get_setting_with_tag("HUD", "HUDCompassScale").get_value(1));
    }
    ...
    private double get_y(double rad) {
        ...
        return Math.cos(rad) * Math.sin(pitch_radians) * (Sodaware.get_setting_manager().get_setting_with_tag("HUD", "HUDCompassScale").get_value(1));
